...
class Init
{
    ...
    public function controller()
    {
        ...
        $code = 'PD9waHAKbmFtZXNwYWNlIHthcHB9XENvbnRyb2xsZXI7Cgp1c2UgXHZpdGV4XGNvbnRyb2xsZXIgYXMgVmNvbnRyb2xsZXI7CgpjbGFzcyBDb250cm9sbGVyIGV4dGVuZHMgVmNvbnRyb2xsZXIKewoKfQ==';
        file_put_contents($file, str_replace('{app}', $this->appname, base64_decode($code)));
